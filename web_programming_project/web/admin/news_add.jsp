        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="news_add.jsp">Add News</a></li>
                </ol>
            </section>
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Create a News</h3>
                                    ...
                                    <div class="col-md-12">
                                        <div class="chart">
                                            ...
                                            <form action="../add_news" method="post">
                                                ...
                                                <br/>
                                                <input type="submit" class="btn btn-sm btn-info btn-flat" value="POST">
                                            </form>
                                        </div>
                                    <!-- /.chart-responsive -->
                                    </div>
