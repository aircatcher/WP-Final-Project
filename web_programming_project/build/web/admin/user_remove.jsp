        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><i class="fa fa-comments"></i> Users</a></li>
                </ol>
            </section>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="chart">
                                            <%
                                                User thisUser;
                                                thisUser = DB_Connect_Admin.chooseUser(Integer.parseInt(request.getParameter("id")));
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td>Password:</td>
                                                    <td><%=thisUser.getPassword()%></td>
                                                </tr>
                                                <tr>
                                                    <td>Name:</td>
                                                    <td><%=thisUser.getName()%></td>
                                                </tr>
                                                <tr>
                                                    <td>Type:</td>
                                                    <td><%=thisUser.getType()%></td>
                                                </tr>
                                                <tr>
                                                    <td>Last Login:</td>
                                                    <td><%=thisUser.getLastLogin()%></td>   
                                                </tr>
                                                <tr><td><font style="color:transparent">.</font></td></tr>
                                            </table>
                                            <table>
                                                ...
                                                <a href="user_list.jsp" class="btn btn-default btn-flat">No</a>
                                            </table>
                                        </div>
                                    <!-- /.chart-responsive -->
                                    </div>
