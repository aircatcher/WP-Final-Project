        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              %>
              <span class="info-box-number"><%=u%>
                  <small><% if(u<=1) { %>user<%} else if(u>1) {%>users<% } %></small>
              </span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <%
                //ArrayList<Image> slideshows = DB_Connect_Admin.getImage();
                
                int prod;
                for(prod = 0; prod < productList.size(); prod++){
                    Product product = productList.get(prod);
                }
              %>
              <span class="info-box-number"><%=prod%><small>
                      <%if(prod<=1){ %> product<%} else if(prod>1) { %> products <% } %></small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <a href="news_list.jsp">
            ...
            <div class="info-box-content">
              ...
              %>
              <span class="info-box-number"><%=n%>
                  <small><% if(n<=1) { %> article<%} else if(n>1) {%> articles<% } %></small>
              </span>
            </div>
            <!-- /.info-box-content -->
          </div></a>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <a href="comment_list.jsp">
            ...
            <div class="info-box-content">
              ...
              <%
                  commentList = DB_Connect_Admin.getCommentList();
                  for(c = 0; c < commentList.size(); c++){
                    News news = DB_Connect_Admin.chooseNews(commentList.get(c).getNewsId());
                  }
              %>
              <span class="info-box-number"><%=c%>
                  <small><% if(c<=1) { %> comment<%} else if(c>1) {%> comments<% } %></small>
              </span>
            </div>
            <!-- /.info-box-content -->
          </div></a>
