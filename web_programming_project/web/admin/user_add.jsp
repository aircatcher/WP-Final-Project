        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="user_add.jsp">Add New User</a></li>
                </ol>
            </section>
                                        ...
                                        <div class="chart">
                                            ...
                                            <form action="../add_user" method="post">
                                                <table>
                                                    ...
                                                    <tr><td>Admin / User: &nbsp;</td><td><input type="text" name="type"></td></tr>
                                                </table>
                                                <br/>
                                                <input type="submit" class="btn btn-primary btn-flat" value="Add User">
                                            </form>
                                        </div>
                                    <!-- /.chart-responsive -->
                                    </div>
