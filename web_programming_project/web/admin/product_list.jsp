                                        ...
                                        <div class="chart">
                                            ...
                                            <table>
                                                <tr style="border:5px solid transparent">
                                                    ...
                                                    <th>RELEASE DATE</th><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                                    <th>ACTIONS</th>
                                                </tr>
                                                <%
                                                    for(c = 0; c < productList.size(); c++){
                                                %>
                                                <tr style="border:5px solid transparent">
                                                    ...
                                                    <td><%=productList.get(c).getDate()%></td><td></td>
                                                    <td>
                                                        <a href="product_edit.jsp?id=<%=productList.get(c).getId()%>" class="btn btn-default btn-flat">EDIT</a>
                                                        <a href="product_remove.jsp?id=<%=productList.get(c).getId()%>" class="btn btn-danger btn-flat">DELETE</a>
                                                    </td>
                                                </tr>
                                                <%
                                                    }
